...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      ...
      powerPreference: 'high-performance', premultipliedAlpha: false, preserveDrawingBuffer: false,
    });
    ...
    let paused = false;
    let inView = true;
    const io = new IntersectionObserver((e) => { inView = e[0]?.isIntersecting ?? true; });
    io.observe(mount);
